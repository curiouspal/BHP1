...
library("foreign")
ph <- read.delim("~/Documents/BoulderHousingPartnersData/PH.dat", na.strings="999") ## Import PH data from Tab delimited .dat file.
s8 <- read.delim("~/Documents/BoulderHousingPartnersData/S8_NA_999.dat", na.strings="999") ## Import S8 data from Tab delimited .dat file.
